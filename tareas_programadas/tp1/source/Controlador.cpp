...
void Controlador::selectionSort(Ordenador ordenador) {
...
void Controlador::insertionSort(Ordenador ordenador) {
...
void Controlador::mergeSort(Ordenador ordenador) {
    // Ordenar por mezcla
    // Crear una copias de los arreglos
...
void Controlador::heapSort(Ordenador ordenador) {
...
void Controlador::quickSort(Ordenador ordenador) {
    // Ordenar por rápido
    // Crear una copias de los arreglos
...
void Controlador::radix(Ordenador ordenador) {
